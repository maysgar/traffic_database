...
CREATE TABLE USER(
  ...
  CONSTRAINT USER_UK UNIQUE (Email, Mobile),
...
CREATE TABLE DRIVER(
  ...
  CONSTRAINT DRIVER_FK_USER FOREIGN KEY (Dni) REFERENCES USER
);
...
CREATE TABLE VEHICLE(
  ...
  CONSTRAINT VEHICLE_FK_USER FOREIGN KEY (Dni) REFERENCES USER
);
...
CREATE TABLE TICKET(
  ...
  */
  ...
  CONSTRAINT TICKET_FK_USER FOREIGN KEY (Dni) REFERENCES USER ON DELETE CASCADE,
