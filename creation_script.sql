...
CREATE TABLE VEHICLE(
  ...
  CONSTRAINT VEHICLE_FK_PEOPLE FOREIGN KEY (Dni) REFERENCES PEOPLE ON DELETE CASCADE, --AÑADIR
  CONSTRAINT VEHICLE_FK_ESPECS FOREIGN KEY (brand,model) REFERENCES POWER_VEHICLE ON DELETE CASCADE --AÑADIR AL REPORT
);
