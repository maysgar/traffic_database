...
CREATE TABLE DRIVER(
  ...
  CONSTRAINT DRIVER_PK PRIMARY KEY (DriverDni,type),
  CONSTRAINT DRIVER_AGE CHECK (age >= 18),
  CONSTRAINT DRIVER_FK_PEOPLE FOREIGN KEY (DriverDni) REFERENCES PEOPLE
);
...
CREATE TABLE DRIVES_VEHICLE( /*n:n relation between Driver:Vehicle*/
  ...
  type VARCHAR2(3) NOT NULL,
  nPlate VARCHAR2(7) NOT NULL,
  CONSTRAINT DRIVES_VEHICLE_PK PRIMARY KEY (DriverDni,type,nPlate),
  CONSTRAINT DRIVES_VEHICLE_FK_DRIVER FOREIGN KEY (DriverDni,type) REFERENCES DRIVER ON DELETE CASCADE,
