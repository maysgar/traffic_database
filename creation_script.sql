...
DROP VIEW OWNER CASCADE CONSTRAINTS;
...
DROP TABLE SANCTIONSTATE CASCADE CONSTRAINTS;
...
CREATE TABLE VEHICLE(
  ...
  CONSTRAINT VEHICLE_UK UNIQUE (VIN),
...
CREATE TABLE SANCTIONSTATE(
  sanctionState VARCHAR2(10) NOT NULL,
  CONSTRAINT SANCTIONDATE_PK PRIMARY KEY (sanctionState)
);
...
CREATE TABLE TICKET(
  ...
  */
  ...
  CONSTRAINT TICKET_FK_PAYMENT FOREIGN KEY (payment) REFERENCES PAYMENT ON DELETE CASCADE,
  CONSTRAINT TICKET_FK_SANCTIONSTATE FOREIGN KEY (sanctionState) REFERENCES SANCTIONSTATE ON DELETE CASCADE
);
...
CREATE TABLE ALLEGATION(
  ...
  */
  ...
  direction VARCHAR2(5),
  nPlate VARCHAR2(7),
  Dni VARCHAR2(9), /*1:n relation between Driver/Owner:Allegation*/
  ...
  CONSTRAINT ALLEGATION_FK_STATUS FOREIGN KEY (status) REFERENCES STATUS ON DELETE CASCADE
);
