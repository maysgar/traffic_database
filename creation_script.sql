...
CREATE TABLE DRIVER(
  ...
  CONSTRAINT DRIVER_FK_PEOPLE FOREIGN KEY (Dni) REFERENCES PEOPLE
);
...
CREATE TABLE RADAR(
  ...
  CONSTRAINT DIRECTION_TYPE CHECK (direction IN ('ASC', 'DESC')),
...
CREATE TABLE OBSERVATION(
  ...
  */
  ...
  CONSTRAINT DIRECTION_TYPE_OBS CHECK (direction IN ('ASC', 'DESC')),
...
CREATE TABLE TICKET(
  ...
  */
  ...
  CONSTRAINT TICKET_SANCTIONSTATE CHECK (sanctionState IN ('Registered', 'Issued', 'Received', 'Fulflled', 'Non-paid')),
  CONSTRAINT DIRECTION_TYPE_TK CHECK (direction IN ('ASC', 'DESC'))
);
