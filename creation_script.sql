...
CREATE TABLE OWNER(
  OName VARCHAR2(35) NOT NULL,
  OSurname_1 VARCHAR2(15) NOT NULL,
  OSurname_2 VARCHAR2(15),
  OAddress VARCHAR2(42) NOT NULL,
  OTown VARCHAR2(35) NOT NULL, /*PONERLO EN EL REPORT*/
  ODni VARCHAR2(9) NOT NULL,
  OMobile NUMBER(9),
  OEmail VARCHAR2(50),
...
CREATE TABLE DRIVER(
  ...
  DSurname_1 VARCHAR2(15) NOT NULL,
  DSurname_2 VARCHAR2(15),
  DAddress VARCHAR2(42) NOT NULL,
  DTown VARCHAR2(35) NOT NULL, /*PONERLO EN EL REPORT*/
  DDni VARCHAR2(9) NOT NULL,
  DMobile NUMBER(9),
  DEmail VARCHAR2(50),
