...
INSERT INTO VEHICLE (nPlate,VIN,registration,color,itv,Dni)
SELECT DISTINCT MATRICULA,VIN,TO_DATE(FECHA_MATRICULA,'YYYY-MM-DD'),COLOR,TO_DATE(FECHA_ITV,'YYYY-MM-DD'),NIF_DUENO
FROM FSDB.MEGATABLE;
/*
  250 ROWS CREATED
*/

INSERT INTO POWER_VEHICLE (brand, model, power, nPlate)
SELECT DISTINCT 
